...
//                    if (rand == 0)
//                        mat4.setToRotation(Vector3.X, MathUtils.random(0.0f, 360f));
//                    else if (rand == 1)
//                        mat4.setToRotation(Vector3.Y, MathUtils.random(0.0f, 360f));
//                    else
//                        mat4.setToRotation(Vector3.Z, MathUtils.random(0.0f, 360f));
...
//            CULLING_FACTOR = camera.far; // no culling as all objects can be seen rotating
        ...
        // size of box
        size = 2f; // look in blender at the size of you model, mine is 2x2x2 meters
